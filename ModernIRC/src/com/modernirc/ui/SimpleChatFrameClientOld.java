...
public class SimpleChatFrameClientOld extends JFrame {
	...
	public static void main(String[] args) throws BadLocationException {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SimpleChatFrameClientOld frame = new SimpleChatFrameClientOld();
	...
	public SimpleChatFrameClientOld() {
	 ...
	 * Create the frame.
	 */
	public SimpleChatFrameClientOld(IntfSenderModel sender, ListModel<String> clientListModel, Document documentModel) {
		this.sender=sender;
